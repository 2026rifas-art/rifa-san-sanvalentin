  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-red-50 to-rose-100 relative">
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-50 bg-gradient-to-r from-green-500 to-green-600 text-white w-16 h-16 rounded-full shadow-2xl hover:scale-110 transition-all flex items-center justify-center"
      >
      ...
      {/* Chatbot */}
      {showBot && (
        <div className="fixed bottom-24 right-6 z-50 bg-white rounded-2xl shadow-2xl w-80 border-2 border-gray-200">
          ...
          <div className="p-4 h-64 overflow-y-auto">
            ...
            <div className="space-y-2">
              <button className="w-full text-left bg-pink-50 hover:bg-pink-100 p-3 rounded-lg text-sm font-semibold transition-colors">
      ...
      {showCheckout && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl shadow-2xl max-w-md w-full p-8 relative">
            ...
            <h3 className="text-3xl font-black text-gray-800 mb-6">Finalizar Compra</h3>
            
            <div className="bg-gradient-to-r from-red-50 to-pink-50 rounded-2xl p-6 mb-6">
              <div className="flex justify-between mb-3">
                <span className="font-bold text-gray-700">Boletos:</span>
                <span className="text-2xl font-black text-gray-800">
                  {selectedPackage ? selectedPackage.qty : selectedTickets}
                </span>
              </div>
              <div className="border-t-2 border-pink-200 my-3"></div>
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-red-500 to-pink-500 hover:from-red-600 hover:to-pink-600 text-white py-4 rounded-xl font-black text-xl transition-all hover:scale-105 shadow-xl flex items-center justify-center gap-3 mb-4"
            >
      ...
      {showGratification && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl shadow-2xl max-w-md w-full p-8 text-center">
            <div className="w-20 h-20 bg-gradient-to-r from-green-400 to-green-600 rounded-full mx-auto mb-6 flex items-center justify-center animate-bounce">
              <Check className="w-12 h-12 text-white" />
            </div>
            
            <h3 className="text-3xl font-black text-gray-800 mb-4">¡Pago Exitoso! 🎉</h3>
            <p className="text-xl text-gray-600 mb-6 font-semibold">
              Tus boletos han sido apartados
            </p>
      ...
      <footer className="relative z-10 bg-gray-900 text-white py-12">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-8">
            ...
            <h3 className="text-2xl font-black mb-2">Rifa San Valentín 2026</h3>
            <p className="text-xl font-bold text-red-400 mb-4">
              $20,000 en premios • 5 ganadores
            </p>
            <p className="text-gray-400 mb-6">
              Sorteo: 13 de febrero 2026 a las 8:00 PM | Lotería Nacional
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm">
                <li>✓ Sorteo transparente</li>
                <li>✓ Pagos seguros</li>
                <li>✓ Base oficial verificable</li>
                <li>✓ Ganadores reales</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm">
                ...
                <li>📧 info@rifasanvalentin.com</li>
                <li>⏰ Lun-Dom: 9AM - 9PM</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm">
                <li>📘 Facebook: @RifaSanValentin</li>
                <li>📷 Instagram: @rifasanvalentin</li>
                <li>🐦 Twitter: @RifaValentin</li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-gray-800 pt-8">
            <div className="flex flex-wrap justify-center gap-6 mb-6 text-sm">
              <a href="#politica-privacidad" className="text-gray-400 hover:text-pink-400 transition-colors flex items-center gap-1">
                <Lock className="w-4 h-4" />
                Política de Privacidad
              </a>
              <a href="#politica-sorteo" className="text-gray-400 hover:text-pink-400 transition-colors flex items-center gap-1">
                <FileText className="w-4 h-4" />
                Bases del Sorteo
              </a>
              <a href="#terminos" className="text-gray-400 hover:text-pink-400 transition-colors flex items-center gap-1">
                <Shield className="w-4 h-4" />
                Términos y Condiciones
              </a>
            </div>
            
            <div className="max-w-2xl mx-auto bg-gray-800 rounded-xl p-4 mb-6">
              <p className="text-xs text-gray-400 text-center leading-relaxed">
                ⚠️ <strong>Juega responsablemente.</strong> Esta rifa se realiza con fines de entretenimiento. 
                El sorteo se basa en los resultados oficiales de la Lotería Nacional de México. 
                Aplican términos y condiciones. Prohibida su venta a menores de 18 años.
              </p>
            </div>
            
            <div className="text-center">
              <p className="text-gray-500 text-sm mb-2">
                © 2026 Rifa San Valentín. Todos los derechos reservados.
              </p>
              <p className="text-xs text-gray-600">
                Desarrollado con 💘 para celebrar el amor
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="fixed bottom-6 left-6 z-40 hidden lg:block">
        <div className="bg-white rounded-xl shadow-lg p-3 border-2 border-green-400">
          <div className="flex items-center gap-2 text-xs">
            ...
            <div>
              <p className="font-black text-gray-800">SORTEO OFICIAL</p>
              <p className="text-gray-600">Lotería Nacional</p>
            </div>
          </div>
        </div>
      </div>
